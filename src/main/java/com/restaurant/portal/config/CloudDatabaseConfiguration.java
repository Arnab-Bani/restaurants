package com.restaurant.portal.config;
...
@Configuration
@EnableMongoRepositories("com.restaurant.portal.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory) throws Exception {
        ...
        mongobee.setChangeLogsScanPackage("com.restaurant.portal.config.dbmigrations");
